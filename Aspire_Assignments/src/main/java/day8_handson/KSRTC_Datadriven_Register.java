...
public class KSRTC_Datadriven_Register {
	WebDriver driver;
  ...
  public void f() throws InterruptedException, IOException, AWTException {
	  ...
	  FileInputStream fs=new FileInputStream(".\\Datadriven1.xlsx");
	  ...
	  for(int i=1;i<=lastrow;i++){
		  driver.findElement(By.xpath("(//div[@class='radio-btn'])[2]")).click();
		  Thread.sleep(1000);
		  ...
		  Thread.sleep(1000);
		  driver.findElement(By.xpath("//label[contains(text(),'Full Name')]/preceding-sibling::input")).sendKeys(name);
		  Thread.sleep(1000);
		  driver.findElement(By.xpath("//label[contains(text(),'Mobile Number')]/preceding-sibling::input")).sendKeys(mobile);
		  Thread.sleep(1000);
		  driver.findElement(By.xpath("(//label[contains(text(),'Password')]/preceding-sibling::input)[1]")).sendKeys(password);
		  Thread.sleep(1000);
		  driver.findElement(By.xpath("(//label[contains(text(),'Password')]/preceding-sibling::input)[2]")).sendKeys(password);
		  Thread.sleep(1000);
